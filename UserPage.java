...
public class UserPage extends JFrame implements ActionListener{
	...
	public UserPage(){
		...
		searchBtn.setBounds(185,btnvpos,120,30); //x,y,w,h
		...
		backButton = new JButton("< Log Out");
      	backButton.setBounds(10,10,110, 30);
		backButton.setFocusable(false);
      	...
      	homeButton.setBounds(850,10,130, 30);
	...
	public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == borrowBtn){
			...
			if(em != null){
				userBooksIO.borrowedBooks(em);
				userBooksIO.updateAllBooks(Books);
				updateTextArea();
